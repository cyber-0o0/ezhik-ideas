...
func handleSupervisorStartup(c *gin.Context) {
	...
	systemPrompt := `Ты - Supervisor Agent (v2.7.1). Твоя задача: разработать полный пакет для стартапа на основе цели пользователя. 
Ты координируешь работу четырех специалистов:
